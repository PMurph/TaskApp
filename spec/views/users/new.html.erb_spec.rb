...
describe 'users/new' do
    ...
    it 'should have a form with labels "Username", "Password", "Retype Password" and "Email Address" labels' do
    ...
    it 'should have a form with inputs for username, password, retyped password, email addresses and creating the user' do
